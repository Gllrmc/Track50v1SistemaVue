  ...
  export default {
    ...
    methods: {
                ...
                case 'lu' : {
                    if (!item.luhoras){
                        ...
                        axios.delete('api/Registros/Eliminar/'+indice,configuracion).then( () => {
                            ...
                            var fhaux = new Date(new Date(item.lufecregistracion).getTime() - new Date(item.lufecregistracion).getTimezoneOffset() * 60000).toISOString();
        ...
        confirmaluhoras(item){
            ...
            item.lufhdesde = new Date(new Date(me.lufdesde).getTime() + lumindesde * 60000 - new Date(me.lufdesde).getTimezoneOffset() * 60000).toISOString();
            item.lufhhasta = new Date(new Date(me.lufhasta).getTime() + luminhasta * 60000 - new Date(me.lufdesde).getTimezoneOffset() * 60000).toISOString();
